...
def vanilla_federated_demo(config: Dict):
    ...
    print(str(getsizeof(model)) + "Bytes.")
...
if __name__ == "__main__":
    ...
    if method in ["ridge", "ip"]: # "ridge": without intrinsic plasticity(IP), "ip": with IP
        vanilla_demo(config)
    elif method in ["fedip", "incfed"]: # "fedip": with IP, "incfed": without IP
